...
rem May 16, 2013 - on permission error, display message
rem
rem Usage:
rem   live-update.vbs {file path of
rem       WideOrbit-generated file, NowPlaying.xml}
rem Usage example:
rem   live-update.vbs "\\HOLMES\D\NowPlaying.xml"
rem
rem But really, you'll want to create a shortcut icon on the Disk
rem     Jockey's desktop to start this program.
rem That shortcut should contain as its target:
rem
rem     %COMSPEC% /K C:\Windows\System32\cscript.exe Z:\Qplaylist\live-update.vbs Z:\NowPlaying.XML
rem
rem     To test this, create an (empty) C:\QPlaylist\test.XML and copy
rem         this to your Run box:
rem
rem     %COMSPEC% /K cscript C:\QPlaylist\live-update.vbs C:\QPlaylist\test.XML
rem
...
rem   https://technet.microsoft.com/en-us/library/ee692852.aspx
...
Do While True
  ...
  WScript.StdOut.Write "Updated." & _
  n & n
Loop
